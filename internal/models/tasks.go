...
type Task struct {
	...
	// RFC-001 §5 Run State Model: CREATED -> QUEUED -> RUNNING -> SUCCEEDED|FAILED — simplified here to Pending/Queued/Running/Completed as plain strings rather than the full RFC-001 state machine (see internal/jobstate for an unused draft of the fuller model)
